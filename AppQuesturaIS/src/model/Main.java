...
public class Main {
	...
	public static void main(String[] args) throws Exception {
		DatabaseManager.init("jdbc:postgresql://localhost:5432/elaborato_is", "admin", "password");
		  ...
		  DatabaseManager.dropTable(true); DatabaseManager.createTable();
		  
		  Person sbatachiones = new Person("TIA3", "Mattias", "Giambirtones", 't',
		  "Terronia", new Calendar.Builder().setDate(2002, Calendar.DECEMBER,
		  ...
		  Reservation res = new Reservation(ReservationType.COLLECTION,
		  LocalDateTime.now(), pass, sbatachiones, ps); res.insert();
		 
		System.out.println(DatabaseManager.getPerson("TIA3"));
